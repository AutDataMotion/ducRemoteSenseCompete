...
urlpatterns = [
    ...
    path('result/themeTeams', themeTeams),
    path('result/teamResultDetail', teamResultDetail),
    path('result/topScoreDaily', topScoreDaily),
    path('result/registAndSubmitDaily', registAndSubmitDaily),
    path('result/teamScoreDaily', teamScoreDaily),
    path('result/leaderboard_out', leaderboard_out),
]
